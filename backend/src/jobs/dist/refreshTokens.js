...
function refreshExpiringTokens() {
    return __awaiter(this, void 0, void 0, function () {
        var sevenDaysFromNow, _a, users, error, _i, _b, user, response, newToken, expiresIn, newExpiresAt, err_1, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    err_1 = _c.sent();
                    console.error("\u2717 Failed to refresh token for user " + user.id + ":", err_1);
                    return [3 /*break*/, 7];
                case 7:
                    _i++;
                    return [3 /*break*/, 2];
                ...
                case 9:
                    error_1 = _c.sent();
                    console.error('Token refresh job failed:', error_1);
                    return [3 /*break*/, 10];
